...
describe "Iom::PHP::Strtotime::TimeShort12" do
  it "should accept '10:00 PM' 1" do
    Iom::PHP::Strtotime.strtotime("10:00 PM", NOW).should eq Time.parse_rfc3339("2005-10-18T10:00:00+00:00")
  end
end
